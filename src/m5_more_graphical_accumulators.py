...
def run_test_draw_circles_from_rectangle():
    ...
    # Test 1:
    rectangle = rg.Rectangle(rg.Point(300, 300), rg.Point(400, 200))
    rectangle.fill_color = 'green'
    rectangle.outline_color = 'blue'
    draw_circles_from_rectangle(7, 3, rectangle, window1)

    # Test 2:
    rectangle = rg.Rectangle(rg.Point(650, 550), rg.Point(700, 500))
    rectangle.fill_color = 'blue'
    rectangle.outline_color = 'orange'
    draw_circles_from_rectangle(1, 8, rectangle, window1)
    window1.close_on_mouse_click()

    window2 = rg.RoseWindow(1000,1000)

    # Test 3:
    rectangle = rg.Rectangle(rg.Point(800, 600), rg.Point(900, 500))
...
def draw_circles_from_rectangle(m, n, rectangle, window):
    ...
    for k in range(n):
        circle = rg.Circle(rg.Point(rectangle.corner_1.x-(rectangle.get_height())*(k+1)+1/2*rectangle.get_height(), rectangle.corner_1.y-1/2*rectangle.get_height()), 1/2*rectangle.get_height())
        circle.fill_color = rectangle.fill_color
        circle.attach_to(window)

    for k in range(m):
        circle = rg.Circle(rg.Point(rectangle.corner_2.x-1/2*rectangle.get_width(), rectangle.corner_2.y-(rectangle.get_width())*(k+1)+1/2*rectangle.get_width()), 1/2*rectangle.get_width())
